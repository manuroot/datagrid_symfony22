...
use Application\CertificatsBundle\Entity\Docchangements;
use Application\CertificatsBundle\Form\DocchangementsType;
...
class DocchangementsController extends Controller {
    ...
    public function indexAction() {
        ...
        $query = $em->getRepository('ApplicationCertificatsBundle:Docchangements')->myFindAll();
        ...
        return $this->render('ApplicationCertificatsBundle:Docchangements:index.html.twig', array(
    ...
    public function indexoAction() {
        ...
        $entities = $em->getRepository('ApplicationCertificatsBundle:Docchangements')->findAll();
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('ApplicationCertificatsBundle:Docchangements')->find($id);
        ...
        return $this->render('ApplicationCertificatsBundle:Docchangements:show.html.twig', array(
                    'entity' => $entity,
    ...
    public function newAction() {
        ...
        return $this->render('ApplicationCertificatsBundle:Docchangements:new.html.twig', array(
                    'entity' => $entity,
    ...
    public function editAction($id) {
        ...
        return $this->render('ApplicationCertificatsBundle:Docchangements:edit.html.twig', array(
                    'entity' => $entity,
