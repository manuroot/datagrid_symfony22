...
use Application\CertificatsBundle\Entity\ChronoUsergroup;
use Application\CertificatsBundle\Form\ChronoUsergroupType;
...
class ChronoUsergroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ApplicationCertificatsBundle:ChronoUsergroup')->findAll();

        return $this->render('ApplicationCertificatsBundle:ChronoUsergroup:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ApplicationCertificatsBundle:ChronoUsergroup')->find($id);
        ...
        return $this->render('ApplicationCertificatsBundle:ChronoUsergroup:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('ApplicationCertificatsBundle:ChronoUsergroup:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ApplicationCertificatsBundle:ChronoUsergroup:edit.html.twig', array(
            'entity'      => $entity,
