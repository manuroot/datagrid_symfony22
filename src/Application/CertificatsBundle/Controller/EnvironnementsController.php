...
use Application\CertificatsBundle\Entity\Environnements;
use Application\CertificatsBundle\Form\EnvironnementsType;
...
class EnvironnementsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ApplicationCertificatsBundle:Environnements')->findAll();

        return $this->render('ApplicationCertificatsBundle:Environnements:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ApplicationCertificatsBundle:Environnements')->find($id);
        ...
        return $this->render('ApplicationCertificatsBundle:Environnements:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('ApplicationCertificatsBundle:Environnements:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ApplicationCertificatsBundle:Environnements:edit.html.twig', array(
            'entity'      => $entity,
