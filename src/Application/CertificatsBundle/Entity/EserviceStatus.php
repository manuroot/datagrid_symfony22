...
class EserviceStatus
{
  ...
  /**
     ...
     */
    public function addEservice(\Application\CertificatsBundle\Entity\Eservice $eservice)
    {
     ...
     * @param \Application\CertificatsBundle\Entity\Eservice $eservice
     */
    public function removeEservice(\Application\CertificatsBundle\Entity\Eservice $eservice)
    {
