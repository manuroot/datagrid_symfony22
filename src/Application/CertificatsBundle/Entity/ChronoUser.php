...
class ChronoUser
{
  ...
  /**
    ...
    */
     ...
     * Set idgroup
     *
     * @param \Application\CertificatsBundle\Entity\ChronoUsergroup $idgroup
     * @return ChronoUser
     */
    public function setIdgroup(\Application\CertificatsBundle\Entity\ChronoUsergroup $idgroup)
    {
