...
class EproduitStatus
{
  ...
  /**
     ...
     * Add eproduit
     *
     * @param \Application\CertificatsBundle\Entity\Eproduit $produit
     * @return EproduitStatus
     */
    public function addEproduit(\Application\CertificatsBundle\Entity\Eservice $eproduit)
    {
     ...
     * Remove eservice
     *
     * @param \Application\CertificatsBundle\Entity\Eservice $eservice
     */
    public function removeEproduit(\Application\CertificatsBundle\Entity\Eservice $eproduit)
    {
