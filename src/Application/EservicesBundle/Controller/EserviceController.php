...
use Application\EservicesBundle\Entity\Eservice;
...
class EserviceController extends Controller {
    ...
    public function indexAction() {
         ...
         * myFindAll: user,(messervices=0,mes_demande_service=1)
          =========================================== */
        $query_s = $em->getRepository('ApplicationEservicesBundle:Eservice')->myFindAll($user_id, 0);
        $query_d = $em->getRepository('ApplicationEservicesBundle:Eservice')->myFindAll($user_id, 1);
        $query_other = $em->getRepository('ApplicationEservicesBundle:Eservice')->myFindOtherForme($user_id);


        //  $query = $em->getRepository('ApplicationEservicesBundle:Eservice')->findAll();
        /* $user->getUsername();
          $user_id=$user->getId();
          $query = $em->getRepository('ApplicationEservicesBundle:Eservice')->myFindAll($user_id); */
        /*
...
//$paginationa->setDefaultPaginatorOptions(array()
    ...
    public function indexotherservicesAction() {
         ...
         * myFindAll: user,(messervices=0,mes_demande_service=1)
          =========================================== */
        $query = $em->getRepository('ApplicationEservicesBundle:Eservice')->myFindOtherForme($user_id);
        ...
        return $this->render('ApplicationEservicesBundle:Eservice:indexother.html.twig', array(
                    'pagination' => $pagination,
                ));
    }
    ...
    public function indexmesservicesAction() {
         ...
         * myFindAll: user,(messervices=0,mes_demande_service=1)
          =========================================== */
        $query = $em->getRepository('ApplicationEservicesBundle:Eservice')->myFindAll($user_id, 0);
        $paginator = $this->get('knp_paginator');
        ...
        return $this->render('ApplicationEservicesBundle:Eservice:indexservices.html.twig', array(
                    'pagination' => $pagination,
                ));
    }
    ...
    public function indexdemandesservicesAction() {
         ...
         * myFindAll: user,(messervices=0,mes_demande_service=1)
          =========================================== */
        $query = $em->getRepository('ApplicationEservicesBundle:Eservice')->myFindAll($user_id, 1);
        ...
        return $this->render('ApplicationEservicesBundle:Eservice:indexdemandes.html.twig', array(
                    'pagination' => $pagination,
                ));
    }
...
*/
        ...
        return $this->render('ApplicationEservicesBundle:Eservice:new.html.twig', array(
                    'entity' => $entity,
    ...
    public function showAction($id) {
        ...
        $ismine = 0;
        $entity = $em->getRepository('ApplicationEservicesBundle:Eservice')->find($id);
        ...
        return $this->render('ApplicationEservicesBundle:Eservice:show.html.twig', array(
                    'entity' => $entity,
                    'ismine' => $ismine,
    ...
    public function editAction($id) {
        ...
        return $this->render('ApplicationEservicesBundle:Eservice:edit.html.twig', array(
                    'entity' => $entity,
